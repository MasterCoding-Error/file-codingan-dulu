...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Nov 2025 pada 01.32
...
INSERT INTO `transaksi` (`id_transaksi`, `tgl_transaksi`, `bayar`, `id_pegawai`) VALUES
(2, '2025-11-03 02:00:41', 600000, 1),
(5, '2025-11-11 04:20:22', 80000, 2),
(6, '2025-11-11 05:15:59', 200000, 1),
(7, '2025-11-11 05:27:47', 500000, 1),
(8, '2025-11-11 05:29:03', 300000, 1),
(9, '2025-10-14 03:42:41', 0, 2),
(11, '2025-11-03 00:47:31', 0, 1),
(12, '2025-11-11 05:32:13', 0, 1);
...
--
ALTER TABLE `barang`
  MODIFY `id_barang` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `keranjang`
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `stok_barang`
  MODIFY `id_stok` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `supplier`
--
ALTER TABLE `supplier`
  MODIFY `id_supplier` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `transaksi`
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(225) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
COMMIT;
